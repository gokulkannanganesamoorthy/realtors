                ...
                >
                  ...
                  <div className="flex flex-wrap gap-4">
                    {service.features.map((feature, fidx) => (
                      <span key={fidx} className="text-[7.5px] text-brand-primary/60 font-bold uppercase tracking-[0.3em] font-para flex items-center gap-2">
        ...
        <section className="py-20 bg-brand-secondary text-brand-primary text-center px-6 border-t border-brand-primary/5">
             <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
                {[
                  ...
                  <div key={idx} className="p-6 bg-white rounded-2xl border border-brand-primary/5 shadow-sm">
                     <h4 className="text-xl font-heading font-bold text-brand-primary mb-1 tracking-tighter uppercase leading-none">{stat.val}</h4>
                     <p className="text-[8px] uppercase tracking-[0.3em] font-bold opacity-30 font-para leading-none">{stat.label}</p>
                  </div>
                ))}
             </div>
        </section>
